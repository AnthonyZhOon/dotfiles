...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Take the ground truth and run a convolution with nosie to create a probability map of the grid

    // Use the probability map to instantiate world-hypotheses and plan on them

    // Step through the proposed solutions, voting on the next move
